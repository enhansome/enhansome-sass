...
* [Bootstrap 4](https://github.com/twbs/bootstrap) ⭐ 174,911 | 🐛 232 | 🌐 MDX | 📅 2026-09-25 - Bootstrap version 4, the most popular HTML, CSS, and JS framework for developing responsive, mobile first projects on the web.
* [Bulma](https://github.com/jgthms/bulma) ⭐ 50,063 | 🐛 527 | 🌐 CSS | 📅 2026-09-21 - Modern CSS framework based on Flexbox.
* [Foundation for Sites](https://github.com/zurb/foundation-sites) ⭐ 29,793 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-25 - The most advanced responsive front-end framework in the world. Quickly create prototypes and production code for sites that work on any kind of device.
...
* [Sass MQ](https://github.com/sass-mq/sass-mq) ⭐ 1,985 | 🐛 3 | 🌐 SCSS | 📅 2026-09-08 - Sass mixin that helps you compose media queries in an elegant way.
...
* [Modular Scale](https://github.com/modularscale/modularscale-sass) ⭐ 1,958 | 🐛 18 | 🌐 CSS | 📅 2025-11-29 - Modular scale calculator built into your Sass.
...
* [normalize-scss](https://github.com/JohnAlbin/normalize-scss) ⭐ 1,420 | 🐛 2 | 🌐 SCSS | 📅 2023-11-11 -  Sass/Compass version of Normalize.css, a collection of HTML element and attribute rulesets to normalize styles across all browsers.
...
* [Scut](https://github.com/davidtheclark/scut) ⭐ 752 | 🐛 0 | 🌐 SCSS | 📅 2022-02-07 - Collection of Sass utilities to ease and improve the implementations of common style-code patterns.
...
* [Hugo Giraudel Personal Awesome Sass List](https://github.com/HugoGiraudel/awesome-sass) ⭐ 750 | 🐛 0 | 📅 2021-03-05 - Records of Hugo Giraudel's works on Sass.
...
* [dart-sass](https://github.com/sass/dart-sass) ⭐ 4,223 | 🐛 68 | 🌐 Dart | 📅 2026-09-24 - Dart implementation of Sass.
...
* [SharpScss](https://github.com/xoofx/SharpScss) ⭐ 60 | 🐛 0 | 🌐 C# | 📅 2024-11-02 - P/Invoke .NET wrapper around libsass to convert SCSS to CSS supporting NET2.0/NET3.5/NET4.x+ and CoreCLR platform.
