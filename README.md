...
* [Bootstrap 4](https://github.com/twbs/bootstrap) ⭐ 174,902 | 🐛 238 | 🌐 MDX | 📅 2026-09-22 - Bootstrap version 4, the most popular HTML, CSS, and JS framework for developing responsive, mobile first projects on the web.
* [Bulma](https://github.com/jgthms/bulma) ⭐ 50,063 | 🐛 527 | 🌐 CSS | 📅 2026-09-21 - Modern CSS framework based on Flexbox.
* [Foundation for Sites](https://github.com/zurb/foundation-sites) ⭐ 29,796 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-24 - The most advanced responsive front-end framework in the world. Quickly create prototypes and production code for sites that work on any kind of device.
...
* [dart-sass](https://github.com/sass/dart-sass) ⭐ 4,223 | 🐛 67 | 🌐 Dart | 📅 2026-09-23 - Dart implementation of Sass.
