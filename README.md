...
* [Bootstrap 4](https://github.com/twbs/bootstrap) ⭐ 174,711 | 🐛 231 | 🌐 MDX | 📅 2026-09-01 - Bootstrap version 4, the most popular HTML, CSS, and JS framework for developing responsive, mobile first projects on the web.
...
* [Buttons](https://github.com/alexwolfe/Buttons) ⭐ 4,995 | 🐛 17 | 🌐 JavaScript | 📅 2025-06-10 - CSS button library built using Sass and Compass.
...
* [Airbnb Sass and CSS Style Guide](https://github.com/airbnb/css) ⭐ 6,970 | 🐛 23 | 📅 2024-06-04 - Sass and CSS style guide by Airbnb.
...
* [dart-sass](https://github.com/sass/dart-sass) ⭐ 4,218 | 🐛 75 | 🌐 Dart | 📅 2026-09-03 - Dart implementation of Sass.
* [sass-loader](https://github.com/jtangelder/sass-loader) ⭐ 3,893 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-03 - Sass loader for webpack.
