...
* [Bootstrap 4](https://github.com/twbs/bootstrap) ⭐ 174,818 | 🐛 236 | 🌐 MDX | 📅 2026-09-15 - Bootstrap version 4, the most popular HTML, CSS, and JS framework for developing responsive, mobile first projects on the web.
* [Bulma](https://github.com/jgthms/bulma) ⭐ 50,055 | 🐛 529 | 🌐 CSS | 📅 2026-03-01 - Modern CSS framework based on Flexbox.
* [Foundation for Sites](https://github.com/zurb/foundation-sites) ⭐ 29,791 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-16 - The most advanced responsive front-end framework in the world. Quickly create prototypes and production code for sites that work on any kind of device.
...
* [dart-sass](https://github.com/sass/dart-sass) ⭐ 4,221 | 🐛 69 | 🌐 Dart | 📅 2026-09-15 - Dart implementation of Sass.
